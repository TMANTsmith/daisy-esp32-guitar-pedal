...
pub unsafe extern "C" fn process(
    ...
    for i in 0..sample_count as isize {
        let out = freeverb.tick((*input_l.offset(i) as f32, *input_r.offset(i) as f32));
...
#[no_mangle]
pub extern "C" fn set_dampening(freeverb: &mut Freeverb, value: f32) {
...
#[no_mangle]
pub extern "C" fn set_wet(freeverb: &mut Freeverb, value: f32) {
    freeverb.set_wet(value)
}

#[no_mangle]
pub extern "C" fn set_width(freeverb: &mut Freeverb, value: f32) {
    freeverb.set_width(value)
}

#[no_mangle]
pub extern "C" fn set_dry(freeverb: &mut Freeverb, value: f32) {
    freeverb.set_dry(value)
}

#[no_mangle]
pub extern "C" fn set_room_size(freeverb: &mut Freeverb, value: f32) {
