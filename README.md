...
This is a guitar pedal with the goal of combining the audio processing power of the Daisy Seed with the wifi capabilities of the Esp32C series (currently only testing the C6). This way you can fully control the guitar pedal with your phone connected by a website hosted by the esp32 and for low-latantcy tasks physical buttons will be on the board. This will allow for greator flexability through the user being able to add or remove buttons by making changes to the website allowing them to have any configuration they want.
...
The full-pcb inclued a esp32 which is connected to the daisy seed through UART (SPI is also connected but is unused) and includes 2 TS jacks this pcb has been designed tested.
...
|                 Front                 |                Back                 |
| :-----------------------------------: | :---------------------------------: |
| ![front](pictures/front_full_pcb.png) | ![Back](pictures/back_full_pcb.png) |
